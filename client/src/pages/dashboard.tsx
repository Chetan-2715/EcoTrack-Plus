...
export default function Dashboard() {
  ...
  const pointsEarned = Object.entries(habits).reduce((sum, [type, count]: [string, any]) => {
    const pointsMap = { recycle: 5, transport: 4, water: 4, trees: 5 };
      ...
      <main className="py-8 relative z-10">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div data-testid="habit-card-transport">
              <HabitCard
                habitType="transport"
            ...
            <div data-testid="habit-card-water">
              <HabitCard
                habitType="water"
                title="Water Usage"
            ...
            <div data-testid="habit-card-trees">
              <HabitCard
                habitType="trees"
                title="Plant Trees"
          ...
          {/* Progress Summary */}
          <Card className="mt-8 bg-white/95 backdrop-blur-sm rounded-2xl shadow-lg p-8 border border-gray-100" data-testid="progress-summary">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">Your Progress Today</h2>
            <div className="grid md:grid-cols-4 gap-6">
              <div className="text-center">
                <div className="text-3xl font-bold text-eco-primary mb-2" data-testid="total-actions">{totalActions}</div>
                <div className="text-gray-600">Total Actions</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-eco-secondary mb-2" data-testid="points-earned">+{pointsEarned}</div>
                <div className="text-gray-600">Points Earned Today</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-eco-sky mb-2" data-testid="streak">{(userDetails as any)?.user?.streak || 0}</div>
                <div className="text-gray-600">Day Streak</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-eco-earth mb-2" data-testid="rank">#{(userDetails as any)?.user?.rank || 0}</div>
          ...
          {/* Action History */}
          <Card className="mt-8 bg-white/95 backdrop-blur-sm rounded-2xl shadow-lg border border-gray-100" data-testid="action-history">
